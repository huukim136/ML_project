...
def create_hparams(hparams_string=None, verbose=False):
    ...
    hparams = tf.contrib.training.HParams(
        ...
        # Data Parameters              #
        ################################
        training_list='/home/hk/voice_conversion/nonparaSeq2seqVC_code/pre-train/reader/vctk_train.txt',
        validation_list='/home/hk/voice_conversion/nonparaSeq2seqVC_code/pre-train/reader/vctk_val.txt',
